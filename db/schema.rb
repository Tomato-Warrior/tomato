...
ActiveRecord::Schema.define(version: 2020_05_20_080016) do
  ...
  create_table "tag_to_task", force: :cascade do |t|
    t.bigint "tag_id", null: false
    t.bigint "task_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["tag_id"], name: "index_tag_to_task_on_tag_id"
    t.index ["task_id"], name: "index_tag_to_task_on_task_id"
  end
  ...
  add_foreign_key "tag_to_task", "tags"
  add_foreign_key "tag_to_task", "tasks"
